...
abstract class MApps_AppBase_BasePageApp extends MCore_Web_BasePageApp
{
    ...
    {
        $this->getResTool()->addCss('android-cube-app-server/base.css');
        $this->getResTool()->addFootJs('android-cube-app-server/AGlobal.js');
    }

    protected function getTitle()
    {
        return 'android-cube-app-server';
    }
    ...
    public static function createDisplayView()
    {
        ...
        $baseData = array();
        $baseData['static_pre_path'] = 'http://' . MCore_Tool_Conf::getDataConfigByEnv('mix', 's_host') . '/android-cube-app-server-static';
